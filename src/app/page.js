...
const Badge = ({ text, icon: Icon = Dumbbell, color = "bg-purple-50" }) => (
  <motion.span 
    ...
    className={`flex items-center w-fit px-3 py-1 text-sm font-semibold rounded-full ${color}`}
  >
...
export default function Home() {
  ...
  const PartnerCard = ({ title, badge, features }) => (
    <motion.div 
      ...
      className="flex flex-col bg-white rounded-xl w-full py-6 px-4 sm:px-6 shadow-xl"
    >
  ...
  return (
    <div className={`flex flex-col ${poppins.className}`}>
        ...
        <div className="flex flex-col lg:flex-row items-center pt-8 md:pt-12">
          ...
          >
            ...
            <motion.h1 
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-purple-700 mt-2"
            >
              simple et efficace
            </motion.h1>
            <motion.p 
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="w-full bg-purple-700 mt-12 py-6"
      >
              ...
              <div className="flex flex-col mt-6 w-full max-w-md space-y-3">
                {products[activeProduct].cards.map((card, i) => (
                  <motion.div 
                    ...
                    className="bg-white p-4 md:p-5 rounded-xl shadow-md"
                  >
      ...
      <div className="w-full bg-purple-50 py-10 md:py-14">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="text-center text-gray-600 mt-3 max-w-xl mx-auto text-sm md:text-base"
          >
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          <motion.h2 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="text-white font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl"
          >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.3 }}
            className="text-gray-300 font-medium text-sm md:text-base mt-3 max-w-lg"
          >
